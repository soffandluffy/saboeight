        ...
        <div class="modal-content">
          ...
          <div class="carousel carousel-slider center intro-carousel">
            ...
            <div class="carousel-item slide-1">
              ...
              <h5 class="intro-step-title mt-7 center animated fadeInUp">Welcome to my Website</h5>
              <p class="intro-step-text mt-5 animated fadeInUp">This is dashboard and admin panel. You can customize or create something here. Enjoy</p>
            </div>
            <div class="carousel-item slide-2">
              <img src="{{asset('images/gallery/intro-features.png')}}" alt="" class="responsive-img slide-2-img">
              <h5 class="intro-step-title mt-7 center">This website will be integrated to android app.</h5>
              <p class="intro-step-text mt-5">It's still on development tho</p>
              <!-- <div class="row">
                <div class="col s6">
