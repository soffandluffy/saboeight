          	...
          	<div class="card-content">
	            <div class="row">
	            	<form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
			            @csrf
		            	<div class="col s12 m12 l12">
		            		<span class="card-title left">Add Article</span>
		            		<button class="btn deep-purple accent-2 waves-effect waves-light right" type="submit" name="action">Add
	          				</button>
	              			<a href="{{ route('admin.blog.index') }}" class="btn grey lighten-2 waves-effect waves-light right mr-1" style="color: #555">Back
	          				</a>
		            	</div>
		              	<div class="col s12 m12 l12">
		              		<div class="row">
			              		...
			              		<div class="input-field col s12 m12 l12">
							      	...
							      	<input type="file" name="imageurl" id="input-file-now" class="dropify validate"/>
							    </div>
			              	</div>
			              	<div class="row">
